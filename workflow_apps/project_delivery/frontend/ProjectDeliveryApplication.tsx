...
export const componentKey = "workflow.project_delivery"

export function ProjectDeliveryApplication({
  workflowSlug,
}: {
  workflowSlug: string
}) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <h2 className="text-lg font-semibold">项目交付任务</h2>
        {tasks.data?.data
          .filter(
